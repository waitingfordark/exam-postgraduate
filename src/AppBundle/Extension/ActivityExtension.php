...
class ActivityExtension extends Extension implements ServiceProviderInterface
{
    ...
    public function register(Container $container)
    {
        ...
        //custom 编程作业
        $container['activity_type.coding'] = function ($biz) {
            return new Coding($biz);
        };
    }
    ...
    public function getActivities()
    {
        ...
        return array(
            ...
            'coding' => array(
                'meta' => array(
                    'name' => 'course.activity.coding',
                    'icon' => 'es-icon es-icon-link',
                ),
                'controller' => 'AppBundle:Activity/Coding',
                'canFree' => false,
                'visible' => function ($courseSet, $course) {
                    return true;
                },
