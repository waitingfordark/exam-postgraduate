...
class ClassroomController extends BaseController
{
    public function teachingAction(Request $request)
    {
        ...
        //ForCustomOnly 统一排序逻辑 desc=>asc
        $classrooms = $this->getClassroomService()->searchMembers(array('role' => 'teacher', 'userId' => $user->getId()), array('createdTime' => 'asc'), 0, PHP_INT_MAX);
        $classrooms = array_merge($classrooms, $this->getClassroomService()->searchMembers(array('role' => 'assistant', 'userId' => $user->getId()), array('createdTime' => 'asc'), 0, PHP_INT_MAX));
        ...
        $classroomIds = array_slice($classroomIds, $paginator->getOffsetCount(), $paginator->getPerPageCount());
        //end
        ...
        return $this->render('my/teaching/classroom.html.twig', array(
            ...
            'members' => $members,
            'paginator' => $paginator, //ForCustomOnly
        ));
    }
